...
export default function StorageArchitecture() {
  return (
    <section id="storage" className="relative container-custom overflow-hidden  py-6 md:py-8 lg:py-12 scroll-m-18 md:scroll-m-12">
      <div className="absolute top-0 left-0 h-[400px] w-[400px] rounded-full bg-red-100 blur-[140px]" />
