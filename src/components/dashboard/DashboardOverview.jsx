"use client";
import { Terminal, TrendingUp, UserPlus } from "lucide-react";
      ...
      <div className="space-y-6">        
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">          
          ...
          <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
            ...
            <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-2">{patients?.length || 0} Active Records</h3>
              ...
              <div className="flex items-center justify-center py-6">
                <div className="relative w-28 h-28 flex items-center justify-center">
                  ...
                  <div className="text-center">
                    <span className="text-base font-bold block">{patients?.length || 0}</span>
